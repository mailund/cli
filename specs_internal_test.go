...
func checkFlags(t *testing.T, f *flags.FlagSet, argv interface{}) {
	t.Helper()
...
func checkFlagsParams(t *testing.T, f *flags.FlagSet, p *params.ParamSet, argv interface{}) {
	t.Helper()
	checkFlags(t, f, argv)
